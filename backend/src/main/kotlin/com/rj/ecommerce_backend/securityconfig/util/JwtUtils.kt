...
class JwtUtils(
    ...
    // No longer need specificJwtExpirationTimeMs if using config for all JWTs generated here

    private val jwtSecret: String get() = jwtConfig.secret
    // This will now be the primary source for JWT expiration for tokens generated by this utility
    ...
    fun generateJwtToken(authentication: Authentication): String {
        ...
        logger.debug { "Using JWT Expiration (from config): $jwtTokenExpirationMs ms" } // Log the used expiration

        val authorities = userPrincipal.authorities
            .map(GrantedAuthority::getAuthority)

        val now = Date()
        // Use jwtTokenExpirationMs from JwtConfig
        ...
        return Jwts.builder()
            ...
            .setIssuedAt(now)
            .setExpiration(expiryDate) // Use the expiryDate calculated from jwtConfig
